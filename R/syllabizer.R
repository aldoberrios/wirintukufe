...
# Convert digraphs into simple characters for syllabification
  ...
  string   <- gsub("([aeiouəɨ])", ".\\1.", string)
  string   <- gsub("\\.([pţtʧŧkmņnɲŋfθsʃʐɻjɰɣwļlʎ])\\.([aeiouəɨɨ])\\.", ".\\1\\2.", string)
  string   <- gsub("([pţtʧŧkmņnɲŋfθsʃʐɻjɰɣwļlʎ])([pţtʧŧkmņnɲŋfθsʃʐɻjɰɣwļlʎ])", "\\1.\\2", string)
  string   <- gsub("([aeiouəɨ])\\.([pţtʧŧkmņnɲŋfθsʃʐɻjɰɣwļlʎ])\\.([pţtʧŧkmņnɲŋfθsʃʐɻjɰɣwļlʎ])", "\\1\\2.\\3", string)
  string   <- gsub("([aeiouəɨ])\\.([pţtʧŧkmņnɲŋfθsʃʐɻjɰɣwļlʎ])$", "\\1\\2", string)
  string   <- gsub("^([pţtʧŧkmņnɲŋfθsʃʐɻjɰɣwļlʎ])\\.([aeiouəɨ])", "\\1\\2", string)
  string   <- gsub("\\.([pţtʧŧkmņnɲŋfθsʃʐɻjɰɣwļlʎ])\\.([aeiouəɨ])", ".\\1\\2", string)
  string   <- gsub("\\.\\.([aeiouəɨ])", ".\\1", string)
  string   <- gsub("^\\.", "", string)
  string   <- gsub("\\.$", "", string)
